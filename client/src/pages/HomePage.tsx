...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    quote:
      "The bank reconciliation feature alone is worth it. Matches everything automatically.",
  },
  {
...
export default function HomePage() {
  ...
  const LOGO_ITEMS = [
    ...
    {
      label: "Mailchimp",
      imgSrc: "https://cdn.simpleicons.org/mailchimp/1E3A5F",
    },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            ...
            <SmoothScrollReveal className="md:col-span-2">
              <Link
                ...
                className="group relative block rounded-2xl overflow-hidden min-h-[280px] md:min-h-[340px]"
              >
                <div className="absolute inset-0">
                  <img
                    src="/screenshots/features-invoicing-card.png"
                    alt="Smart Invoicing"
                ...
                <div className="relative z-10 p-6 lg:p-8 flex flex-col justify-end h-full absolute bottom-0 left-0 right-0">
                  ...
                  <p className="text-sm text-white/85 leading-relaxed max-w-md mb-3">
                    Create professional invoices in seconds. Auto-numbering,
                    recurring schedules, and instant sending via email with PDF
                    attachments.
                  </p>
            ...
            <SmoothScrollReveal delay={0.06} className="md:col-span-1">
              <TiltCard tiltDegree={3}>
                <Link
                  ...
                  className="block h-full p-5 rounded-2xl border border-border/50 bg-white hover:border-accent-gold/30 hover:shadow-lg hover:shadow-accent-gold/5 hover:-translate-y-0.5 transition-all duration-300 group"
                >
                  <div className="h-24 rounded-xl overflow-hidden border border-border/50 mb-4">
                    <img
                      src="/screenshots/features-expenses-card.png"
                  ...
                  <p className="text-xs text-text-muted leading-relaxed mb-3">
                    Log expenses with IRS Schedule C categories. Drag-and-drop
                    receipt upload with automatic thumbnail generation.
                  </p>
            ...
            <SmoothScrollReveal delay={0.06} className="md:col-span-1">
              <TiltCard tiltDegree={3}>
                <Link
                  to="/features/bank-reconciliation"
                  className="block h-full p-5 rounded-2xl border border-border/50 bg-white hover:border-accent-gold/30 hover:shadow-lg hover:shadow-accent-gold/5 hover:-translate-y-0.5 transition-all duration-300 group"
                >
                  <div className="h-24 rounded-xl overflow-hidden border border-border/50 mb-4">
                    <img
                      src="/screenshots/features-bank-card.png"
                  ...
                  <p className="text-xs text-text-muted leading-relaxed mb-3">
                    Import bank CSV files, auto-match transactions, and
            ...
            <SmoothScrollReveal delay={0.06} className="md:col-span-1">
              <TiltCard tiltDegree={3}>
                ...
                >
                  <div className="h-24 rounded-xl overflow-hidden border border-border/50 mb-4">
                    <img
                      src="/screenshots/features-reports-card.png"
                  ...
                  <p className="text-xs text-text-muted leading-relaxed mb-3">
                    Profit &amp; Loss, Balance Sheet, Cash Flow, A/R Aging, and
                    more — all exportable as PDF or CSV.
                  </p>
                  <span className="inline-flex items-center gap-1 text-xs font-medium text-accent-gold-dark group-hover:text-accent-gold transition-colors">
                    Learn more <ArrowRight className="w-3 h-3" />
                  </span>
            ...
            <SmoothScrollReveal delay={0.06} className="md:col-span-1">
              <TiltCard tiltDegree={3}>
                <Link
                  to="/features/tax-centre"
                  className="block h-full p-5 rounded-2xl border border-border/50 bg-white hover:border-accent-gold/30 hover:shadow-lg hover:shadow-accent-gold/5 hover:-translate-y-0.5 transition-all duration-300 group"
                >
                  <div className="h-24 rounded-xl overflow-hidden border border-border/50 mb-4">
                    <img
                      src="/screenshots/features-tax-card.png"
                      alt="Tax-Ready Exports"
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                    />
                  </div>
                  <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <p className="text-xs text-text-muted leading-relaxed mb-3">
                    Quarterly estimated tax reminders, 1099 tracker, mileage log
                    with IRS rate, and one-click hand-off.
                  </p>
                  <span className="inline-flex items-center gap-1 text-xs font-medium text-accent-gold-dark group-hover:text-accent-gold transition-colors">
                    Learn more <ArrowRight className="w-3 h-3" />
                  </span>
            ...
            <SmoothScrollReveal delay={0.06} className="md:col-span-3">
              <Link
                to="/features"
                className="group relative block rounded-2xl overflow-hidden bg-white border border-border/50 p-6 md:p-8 shadow-md hover:shadow-lg hover:shadow-accent-gold/10 transition-all duration-300"
              >
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-sm text-text-muted leading-relaxed mb-6 max-w-lg">
                      Invite team members with role-based access. Owner, Admin,
                      Accountant, and Member roles with granular permissions.
                      Activity audit logging keeps everyone accountable.
                    </p>
                  ...
                  <div className="rounded-xl overflow-hidden border border-border/50">
                    <img
                      src="/screenshots/features-team-card.png"
            ...
            {[
              ...
              <SmoothScrollReveal key={stat.label} delay={0.08 * i}>
                <div className="text-center">
                  <p className="text-3xl lg:text-4xl font-bold font-heading text-white tracking-tight mb-1">
                    {stat.value}
                  </p>
          ...
          {reduce ? (
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {TESTIMONIALS.map((t) => (
                <div
                  key={t.name}
                  className="p-6 rounded-2xl bg-white border border-border/50 hover:shadow-md hover:shadow-accent-gold/5 transition-all duration-300"
                >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              { name: "Cloudflare R2", desc: "Storage" },
              { name: "CSV Imports", desc: "Bank data" },
              { name: "Gusto", desc: "Payroll" },
              { name: "ADP", desc: "Payroll" },
            ].map((integration, i) => (
                ...
                <TiltCard tiltDegree={3}>
                  <div className="p-4 rounded-2xl bg-white border border-border/50 text-center hover:border-accent-gold/30 hover:shadow-md transition-all duration-300">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-accent-gold-light to-accent-gold/20 flex items-center justify-center mx-auto mb-3 border border-accent-gold/20">
                      <span className="text-lg font-bold text-accent-gold-dark font-mono">
                        {integration.name[0]}
                      </span>
                    </div>
            ...
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <div className="flex justify-center">
                <div className="flex gap-1 bg-white p-0.5 rounded-lg border border-border/50">
                  ...
                  >
                    Annual{" "}
                    <span className="text-[10px] text-accent-gold ml-0.5">
                      Save 20%
                    </span>
                  </button>
                </div>
            ...
            {PLANS.map((plan, i) => {
              ...
              return (
                <SmoothScrollReveal key={plan.id} delay={0.1 * i}>
                  <TiltCard tiltDegree={3}>
                    <div
                      className={`relative flex flex-col p-6 rounded-2xl border-2 transition-all duration-300 hover:shadow-lg ${
                        plan.popular
                          ? "border-accent-gold bg-white shadow-md shadow-accent-gold/10"
              ...
              <SmoothScrollReveal key={i} delay={0.04 * i}>
                <div className="bg-white rounded-xl border border-border/50 overflow-hidden hover:border-accent-gold/20 transition-colors">
                  <button
                    ...
                    className="w-full flex items-center justify-between px-5 py-4 text-left text-sm font-medium text-brand-navy hover:bg-surface-warm transition-colors"
                  >
                    {faq.q}
                    <ChevronDown
