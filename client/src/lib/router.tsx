...
export const router = createBrowserRouter([
  ...
  { path: '/verify-email', lazy: () => import('../pages/VerifyEmailPage').then((m) => ({ Component: m.default })) },
  ...
  { path: '/onboarding', lazy: () => import('../pages/onboarding/OnboardingPage').then((m) => ({ Component: m.default })) },
  {
    path: '/dashboard',
    element: <AuthGuard />,
    children: [
      {
        ...
        children: [
          ...
          { path: 'mileage', lazy: () => import('../pages/dashboard/MileagePage').then((m) => ({ Component: m.default })) },
