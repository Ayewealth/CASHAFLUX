...
const FOOTER_LINKS: Record<string, { label: string; href: string; disabled?: boolean }[]> = {
  ...
  Compare: [
    ...
    { label: 'vs FreshBooks', href: '/compare/freshbooks' },
  ],
  Support: [
  ...
  return (
    <footer className="bg-brand-navy-dark text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 lg:pt-20 pb-10">
          <div className="border-b border-accent-gold/10 pb-12 mb-12">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pb-12 lg:pb-16">
                ...
                {links.map((link) => (
                  <li key={link.label}>
                    {link.disabled ? (
                      ...
                      <Link
                        to={link.href}
                        className="text-sm text-white/50 hover:text-accent-gold transition-colors"
                      >
                        {link.label}
                      </Link>
                    )}
        ...
        <div className="mt-12 pt-8 border-t border-accent-gold/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              href="#"
              className="text-white/40 hover:text-accent-gold transition-colors text-sm"
              aria-label="Twitter"
            >
              Twitter
            </a>
